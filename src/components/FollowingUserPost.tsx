...
export const FollowingUserPost = () => {
  ...
  return (
    <div className="space-y-6 container mx-auto p-4 bg-[#1c1c1e] min-h-screen text-white">
      <h1 className="text-2xl font-bold text-center mb-6">Following User Posts</h1>
      {posts.length === 0 ? (
        <h1 className="font-sans text-3xl text-center text-gray-400">
        ...
        posts.map((post) => (
          <div
            key={post._id}
            className="p-4 bg-[#2b2b2e] rounded-lg shadow-lg border border-gray-600 flex flex-col md:flex-row items-stretch"
          >
            {/* User Info Section */}
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-300 mb-2">
                ...
                {post.text.length > 100 && (
                  ...
                  >
                    {expandedPosts.includes(post._id) ? "Read Less" : "Read More"}
                  </span>
                )}
              </p>
              <div className="flex items-center space-x-6 mt-2">
                <span
                  ...
                  className="cursor-pointer flex items-center space-x-1 text-sm text-gray-300"
                >
                ...
                <span className="flex items-center space-x-1 text-sm text-gray-300">
                  <span>Comments:</span>
