...
export const Coments = ({ comments, onClose, postId }: CommentsProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 md:mr-[170px] md:mt-10">
      <div className="relative bg-white p-6 rounded-lg shadow-lg max-w-md w-full mx-auto overflow-scroll">
        <button 
          onClick={onClose}
